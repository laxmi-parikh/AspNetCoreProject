...
public partial class Admin_Default2 : System.Web.UI.Page
{
    ...
    public void BindGrid()
    {
        ...
        lblExamTitle.Text = "Exam Title &nbsp;:&nbsp;"+ DropDownList2.SelectedItem.Text; 
            //List<Result_Mst> objResult = Result_MstManager.GetResultReport(Convert.ToInt32(Request.QueryString["SettingId"]));
            DataSet objResult = Exam_MstManager.GetResultReport_new(Convert.ToInt32(DropDownList2.SelectedValue));
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
       ...
       obj = Exam_MstManager.GetResultReport_new(Convert.ToInt32(DropDownList2.SelectedValue));
