<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImageBrowser.aspx.cs" Inherits="ImageBrowserPage" StylesheetTheme="none" Theme="none" %><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
		...
		<table width="720px" cellpadding="10" cellspacing="0" border="1" style="background-color:#F1F1E3; margin:15px;">
			<tr>
				...
				<td style="width: 324px;" valign="top">
					<%--Folders:--%><br />
					<asp:DropDownList ID="DirectoryList" runat="server" Style="width: 160px;" OnSelectedIndexChanged="ChangeDirectory" AutoPostBack="true"  Visible="false"/>
					<asp:Button ID="DeleteDirectoryButton" runat="server" Text="Delete" OnClick="DeleteFolder" Visible="false" OnClientClick="return confirm('Are you sure you want to delete this folder and all its contents?');" />
