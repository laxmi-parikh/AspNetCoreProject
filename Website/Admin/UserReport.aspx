                       ...
                       <tr height="30">
                        <td align="left" class="top_pinktab"   colspan="2">
                           &nbsp; <img height="9" src="images/arrow.gif"  />&nbsp;
                            <span class="que1">Candidate Report</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <asp:GridView ID="gvFunction" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Level" ItemStyle-Width="40%" ItemStyle-CssClass="gridviewdata">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Status" ItemStyle-Width="40%" ItemStyle-CssClass="gridviewdata">
                                    <EditItemTemplate>
                                        <asp:Label ID="TextBox1" runat="server" ></asp:Label>
                                    </EditItemTemplate>
                                    <ItemTemplate>
