<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AddFunction.aspx.cs" Inherits="Admin_AddFunction" %>
                       ...
                       <tr height="30">
                        <td align="left" class="top_pinktab"   colspan="2">
                           &nbsp; <img height="9" src="images/arrow.gif"  />&nbsp;
                            <span class="que1">Add Function</span>
                        </td>
                    </tr>
...
&nbsp;
                    ...
                    <tr>
                        <td class="form_font02" colspan="2" >
                            <img height="9" src="images/arrow.gif" width="8" alt="arrow" /><span class="pink_text">List Function</span>
                            </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td class="white_font" width="95%" align="left">
                                                             <asp:Label ID="Label2" runat="server" Text ='<% # Bind("Functionid") %>' Visible="false"></asp:Label> 
