<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true"  CodeFile="ExamTitleReport.aspx.cs" Inherits="Admin_Default2" %>
...
<script language="javascript">
 ...
 <table align="center" border="0" cellpadding="0" cellspacing="0" >
  ...
  <a href="ExamDetail1.aspx?UserId=<%#Eval("UserId") %> &SetId=<%#Eval("SettingId") %>" style="text-decoration:none;"  >
