<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ListSettingInterview.aspx.cs" Inherits="Admin_ListQuestion"  %>
      ...
      <tr height="30">
                        <td align="left" class="top_pinktab" valign="middle"  colspan="2">
                           &nbsp; <img height="9" src="images/arrow.gif"  />&nbsp;
                            <span class="que1" >List Of Setting Interview</span>
                        </td>
                    </tr>
      <tr height="30px">
      ...
      <%--
         <tr height="30px">
                  ...
                  <tr height="30px">
                    ...
                    <td class="form_font" valign="top" align="center">&nbsp;<b>Interview</b></td>
