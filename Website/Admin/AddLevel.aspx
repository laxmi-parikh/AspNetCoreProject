<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AddLevel.aspx.cs" Inherits="Admin_AddLevel" %>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" class="form_font">
        <tr>
            <td align="left" bgcolor="#FFFFFF" valign="top" width="710">
                <table border="0" cellpadding="0" cellspacing="0" class="top_margin02"  width="90%">
                  <tr height="30">
                        <td align="left" class="top_pinktab" valign="middle"  colspan="2">
                           &nbsp; <img height="9" src="images/arrow.gif"  />&nbsp;
                            <span class="que1">Add Level</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td width="15%" class="form_font02">
                            <b>Function</b></td>
                        <td class="style1" height="30" width="85%">
                    ...
                    <tr>
                        ...
                        <td class="style1" height="30" >
                            <asp:TextBox ID="txtSubTitle" runat="server" Width="120px" onkeydown="return CheckNumericKeyCode(event)"></asp:TextBox>
&nbsp;
                                ...
                                <tr>
                                    <td align="left" class="form_font" height="36" valign="middle">
                                        <asp:GridView ID="gvSubTitle" runat="server" AllowPaging="True" 
                                            ...
                                            PageSize="20" Width="100%" CaptionAlign="Top" 
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tr>
                                                                            ...
                                                                            <td class="white_font" width="141">
                                                                                <asp:Label ID="Label1" runat="server" Text='<% # Bind("FunctionName") %>'></asp:Label>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tr>
                                                                            <td width="25">
                                                                                <img class="m_img" height="13" src="images/2arrow.gif" width="11" /></td>
                                                                            <td class="white_font" width="141">
                                                                                <asp:Label ID="Label2" runat="server" Text='<% # Bind("levelname") %>'></asp:Label>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td align="center"  width="121">
                                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="60%">
                                                                        <tr>
                                                                            <td >
                                                                <asp:ImageButton id="LinkButton4" runat="server" CausesValidation="false" CommandArgument='<%#Eval("levelid")%>' CommandName="Delete" 
