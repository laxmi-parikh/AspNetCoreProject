...
public partial class ForgetPassword : System.Web.UI.Page
{
  ...
  //  string failurepage = "failure.html";
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
     ...
     User_Mst obj =User_MstManager.GetPswdByUserName(Convert.ToString(txtemail.Text));
        if (obj != null)
        {
            emailTo = Convert.ToString(txtemail.Text);
    ...
    {
        string str = "<b>Your Password is :</b><br/>";
    ...
    private string MakeBody()
    {
        ...
        str.Append("<table><tr><th colspan='2' align='left> Your Password is</th><br/></tr>");
        //foreach (HeaderValue hv in collection)
        //{
            str.Append("<tr><td>Email </td>&nbsp;&nbsp; <td> :  </td><td><pre> " + txtemail.Text + "</td></pre>");
            str.Append("</tr>");
            str.Append("<br>");
            str.Append("<tr><td>Password </td>&nbsp;&nbsp; <td> :  </td><td><pre> " + Password + "</td></pre>");
            str.Append("</tr>");
            str.Append("<br>");
       // }
        str.Append("</table>");
